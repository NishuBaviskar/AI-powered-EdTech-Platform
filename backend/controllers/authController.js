...
// A new helper function to log activities to avoid repeating code
const logActivity = async(userId, activityType, details = {}) => {
    try {
        ...
        // We log the error but don't stop the main function (like login) from completing
...
export const login = async(req, res) => {
    ...
    try {
        ...
        // --- ADDED THIS LINE TO LOG THE LOGIN EVENT ---
        await logActivity(user[0].id, 'login');
